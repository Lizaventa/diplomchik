// This part of code isn't actually work yet, but it should'nt be removed
package middleware
...
// 	// Decoding of Base64url to JSON format
// 	payloadBytes, err := base64.RawURLEncoding.DecodeString(payload)
// 	if err != nil {
// 		return uuid.Nil, "", fmt.Errorf("DecodeString: %w", err)
// 	}

// 	// Unmarshal payload into CustomClaims structure
// 	var claims tokenClaims
// 	err = json.Unmarshal(payloadBytes, &claims)
// 	if err != nil {
